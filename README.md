...
| **1.1版本** | `/swthconfig teleportDelay <秒>` | **OP 专用** | 修改传送倒计时（默认0秒） |
...
| **1.1Version** | `/swthconfig teleportDelay <seconds>` | **OP Only** | Change the teleport countdown (default 0 seconds) |
...
### Version 1.1 adds teleport countdown! Default is 0 seconds
```
{
  "maxHomes": 5,
  "maxWarps": 5,
